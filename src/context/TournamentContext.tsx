...
<ul>
  ...
  <li>Допускается 2 запасных игроков (максимум 7 человек в заявке).</li>
  <li>Указание ролей не требуется — игроки могут менять позиции в любой момент.</li>
</ul>
...
<ul>
  ...
  <li>Запасные игроки не должны нарушать лимит MMR при выходе в игру.</li>
  <li>На момент матча в команде может единовеременно заменяться только 2 игрока.</li>
</ul>
<h3><strong>1.4 Уточнение</strong></h3>
<ul>
  <li>Разрешено брать на замену игроков выбывших из турнира.</li>
  <li>Запрещено участия игрока, который не был зарегестрирован ни в одной из команд, а также в свободных игроках.</li>
</ul>
...
<ul>
  ...
  <li>Капитан должен предоставить название и логотип команды.</li>
...
<ul>
  <li>Общее время на паузу 15 минут.</li>
</ul>
...
<p><strong>Если написано руками - смотрите ниже.</strong></p>
<ul>
...
<ul>
  ...
  <li>Проводить матч без участия представителя организаторов.</li>
</ul>
<h3><strong>3.7 Софт</strong></h3>
<p>Если вы намеренны использовать сторонние програмы для получение преимущества в игре, то вы буджете забанены навсегда на всех турнирах сервера.<br>Если в матче будет замечено использование софта, то команда игрока использововшего софт будет дисквалифицирована на месте без дальнейшего обжалования.</p>
...
<ul>
  ...
  <li>Вопросы по матчам направляются исключительно своему организатору.</li>
</ul>
...
<p>Капитан команды после матчав имеет право запросить проверку игры на софт. (см. <strong>3.7</strong>)<br>Принимайте поражение с гордостью и не обвиняйте каждого в софте.</p>
